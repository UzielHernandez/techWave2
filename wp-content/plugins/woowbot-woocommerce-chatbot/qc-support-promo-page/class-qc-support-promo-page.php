...
if( !class_exists('QcWooBotSupportAndPromoPage') ){


	class QcWooBotSupportAndPromoPage{
...
$heroinstance = new QcWooBotSupportAndPromoPage('woowbot-support');

if( is_admin() )
{
	$heroinstance->plugin_menu_slug = "woowbot"; //Edit Value
	$heroinstance->plugin_name = "WooWBot WooCommerce Chatbot"; //Edit Value
