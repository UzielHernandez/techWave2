...
define('QCLD_WOOCHATBOT_VERSION', '3.4.7');
...
class QCLD_Woo_Chatbot
{
    ...
    public function qc_woowbot_promotion_notice(){
        ...
        $promotion_img = QCLD_WOOCHATBOT_IMG_URL . "/woowbot_promotion.jpg";
        ?>
        <div id="promotion-wpchatbots" data-dismiss-type="qcbot-feedback-notice" class="notice is-dismissible qcbot-feedback" style="background: #000">
            <div class="">
                
                <div class="qc-review-text" >
                <a href="https://www.quantumcloud.com/products/woocommerce-chatbot-woowbot/" target="_blank">
...
-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <ul class="checkbox-list">
                                                    ...
                                                    ?>
                                                    <li>
                                                    <input id="wp_chatbot_show_page_<?php echo $wp_chatbot_page->ID; ?>"
                                                            type="checkbox"
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <ul class="radio-list">
                                                    ...
                                                    <li><img src="<?php echo QCLD_WOOCHATBOT_IMG_URL; ?>/icon-14.png"
                                                             alt=""> <input type="radio" name="woo_chatbot_icon"
                                                                            value="icon-14.png" <?php echo(get_option('woo_chatbot_icon') == 'icon-14.png' ? 'checked' : ''); ?>>
                                                        <span class="qc-opt-dcs-font"><?php esc_html_e('Icon - 13', 'woochatbot'); ?></span>
                                                    </li>
                                                    <li>
                                                    <?php
                                                        ...
                                                        <ul class="radio-list">
                                                            ...
                                                            <li>
                                                                ...
                                                                <label for="wp_chatbot_agent_image_custom" class="qc-opt-dcs-font">
                                                                    ...
                                                                    src="<?php echo esc_attr($wp_chatbot_custom_agent_path); ?>"
                                                                    alt="Agent">
                                    ...
                                    <div class="top-section">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <h3><?php esc_html_e('Bargain Bot for WoowBot', 'woochatbot'); ?></h3>
                                        ...
                                        <h4 class="qcld_woo_chat_plugin_title"><?php esc_html_e('Install Bargain Bot Now! It works with WoowBot', 'woochatbot'); ?></h4>
								...
								<div class="wpbot-chatbot-pro-link">
                                    ...
                                    <div class="support-block support-block-custom support-block-top">
                                		<div class="support-block-img">
                                			<a href="<?php echo esc_url('https://www.quantumcloud.com/products/woocommerce-chatbot-woowbot/'); ?>" target="_blank"> <img src="<?php echo esc_url(QCLD_WOOCHATBOT_PLUGIN_URL.'images/logo-woow.png'); ?>" /></a>
                                		</div>
                                		<div class="support-block-info" style="    padding: 0 40px;">
                                			<h4><a style="    color: #a0408d;font-weight: bold; font-size: 26px;" href="<?php echo esc_url('https://www.quantumcloud.com/products/woocommerce-chatbot-woowbot/'); ?>" target="_blank"><?php esc_html_e('Get the #1 ChatBot for WooCommerce – WoowBot Pro', 'woochatbot'); ?></a></h4>

                                			
                                                <p style="text-align: center;">			
                                                <?php esc_html_e('WoowBot Pro is a WooCommerce Shopping ChatBot that can help Increase your store Sales perceptibly. Shoppers can converse fluidly with the Bot – thanks to its Integration with Google‘s Dialogflow, Search and Add products to the cart directly from the chat interface, get Support and more!', 'woochatbot'); ?>
                                                </p>
                                                <p style="text-align: center;"><?php esc_html_e('The Onsite Retargeting helps your Conversion rate optimization by showing special offers and coupons on Exit Intent, time interval or page scroll-down. Track Customer Conversions with statistics to find out if shoppers are abandoning carts. Get more sales!', 'woochatbot'); ?>	
                                                </p>			
                                			
                                			<a class="IncreaseSales" href="<?php echo esc_url('https://www.quantumcloud.com/products/woocommerce-chatbot-woowbot/'); ?>" target="_blank"><?php esc_html_e('Get the WoowBot Pro Now and Increase Sales!', 'woochatbot'); ?></a>
							...
							<div class="qc-column-6"><!-- qc-column-4 -->
									...
									<div class="support-block support-block-custom">
										...
										<div class="support-block-info">
											<h4><a href="<?php echo esc_url('https://www.quantumcloud.com/products/chatbot-addons/'); ?>" target="_blank"><?php esc_html_e('Multi Language Addon (**new)', 'woochatbot'); ?></a></h4>
											<p><?php esc_html_e('Add multiple language support for your ChatBot. User can change language from drop down menu any time. Admin can select default language. Supports all major languages. Connect with different Dialogflow agents for different languages', 'woochatbot'); ?><p/>
										</div>
									</div>
								</div>								
                        ...
                        <div class="qc-column-6"><!-- qc-column-4 -->
                    		...
                    		<div class="support-block support-block-custom">
                    			...
                    			<div class="support-block-info">
                    				<h4><a href="<?php echo esc_url('https://www.quantumcloud.com/products/chatbot-addons/'); ?>" target="_blank"><?php esc_html_e('Voice Message AddOn (**new)', 'woochatbot'); ?></a></h4>
                    				<p><?php esc_html_e('Allow your customers to record a voice message from the ChatBot interface. Voice messages are saved in the backend to listen to any time. Supports speech to text using Google API. Compatible with all Modern Browsers. Beautiful modern User Interface', 'woochatbot'); ?><p/>
                    			</div>
                    		</div>
                    	</div>								
                        ...
                        <div class="qc-column-6"><!-- qc-column-4 -->
                    		...
                    		<div class="support-block support-block-custom">
                    			...
                    			<div class="support-block-info">
                    				<h4><a href="<?php echo esc_url('https://www.quantumcloud.com/products/chatbot-addons/'); ?>" target="_blank"><?php esc_html_e('Extended UI Addon', 'woochatbot'); ?></a></h4>
                    				<p><?php esc_html_e('Give your beloved ChatBot a facelift. Choose from 2 additional modern, slick and quite fancy templates! These new templates are sure to WOW your website visitors! New loader effect and Extensive color customization options are available!', 'woochatbot'); ?><p/>
                    			</div>
                    		</div>
                    	</div>								
                        ...
                        <div class="qc-column-6"><!-- qc-column-4 -->
                    		...
                    		<div class="support-block support-block-custom">
                    			...
                    			<div class="support-block-info">
                    				<h4><a href="<?php echo esc_url('https://www.quantumcloud.com/products/chatbot-addons/'); ?>" target="_blank"><?php esc_html_e('Simple Text Responses Pro', 'woochatbot'); ?></a></h4>
                    				<p><?php esc_html_e('Create text based responses for your customer queries easily with CSV export/import feature. STR Pro supports categories for Simple text responses for back end and front end. HTML visual editor to format your ChatBot replies and removing stop words for better search mathing.', 'woochatbot'); ?><p/>
                    			</div>
                    		</div>
                    	</div>								
                        ...
                        <p/>
                                ...
                                <div class="qc-column-6"><!-- qc-column-4 -->
                            		...
                            		<div class="support-block support-block-custom">
                            			...
                            			<div class="support-block-info">
                            				<h4><a href="<?php echo esc_url('https://www.quantumcloud.com/products/chatbot-addons/'); ?>" target="_blank"><?php esc_html_e('Export Import Settings', 'woochatbot'); ?></a></h4>
                            				<p><?php esc_html_e('Using the WPBot Pro on multiple websites? Then this nifty little addon may come in handy. This addon allows you to export your settings and import them back in another site or if you want to just keep a back up. Very helpful for porting the Language center settings which can be a handful with lots of options. Grab it now!', 'woochatbot'); ?>
                                            <p/>
                            			</div>
                            		</div>
                            	</div>
								...
								<div class="qc-column-6"><!-- qc-column-4 -->
									...
									<div class="support-block support-block-custom">
										...
										<div class="support-block-info">
											<h4><a href="<?php echo esc_url('https://www.quantumcloud.com/products/chatbot-addons/'); ?>" target="_blank"><?php esc_html_e('Messenger ChatBot Addon', 'woochatbot'); ?></a></h4>
											<p><?php esc_html_e('Utilize the WPBot on your website as a hub to respond to customer questions on FB Page & Messenger', 'woochatbot'); ?></p>
								...
								<div class="qc-column-6"><!-- qc-column-4 -->
									...
									<div class="support-block support-block-custom">
										...
										<div class="support-block-info">
											<h4><a href="<?php echo esc_url('https://www.quantumcloud.com/products/chatbot-addons/'); ?>" target="_blank"><?php esc_html_e('Extended Search', 'woochatbot'); ?></a></h4>
											<p><?php esc_html_e('Extend WPBot’s search power to include almost any Custom Post Type including WooCommerce', 'woochatbot'); ?></p>
								...
								<div class="qc-column-6"><!-- qc-column-4 -->
									...
									<div class="support-block support-block-custom">
										...
										<div class="support-block-info">
											<h4><a href="<?php echo esc_url('https://www.quantumcloud.com/products/chatbot-addons/'); ?>" target="_blank"><?php esc_html_e('ChatBot Session Save Addon', 'woochatbot'); ?></a></h4>
											<p><?php esc_html_e('This AddOn saves the user chat sessions and helps you fine tune the bot for better support and performance.', 'woochatbot'); ?></p>
								...
								<div class="qc-column-6"><!-- qc-column-4 -->
									...
									<div class="support-block support-block-custom">
										...
										<div class="support-block-info">
											<h4><a href="<?php echo esc_url('https://www.quantumcloud.com/products/chatbot-addons/'); ?>" target="_blank"><?php esc_html_e('LiveChat Addon', 'woochatbot'); ?></a></h4>
											<p><?php esc_html_e('Live Human Chat integrated with WPBot', 'woochatbot'); ?><p/>
										</div>
									</div>
								</div><!--/qc-column-4 -->
								...
								<div class="qc-column-6"><!-- qc-column-4 -->
									...
									<div class="support-block support-block-custom">
										...
										<div class="support-block-info">
											<h4><a href="<?php echo esc_url('https://www.quantumcloud.com/products/chatbot-addons/'); ?>" target="_blank"><?php esc_html_e('White Label WPBot', 'woochatbot'); ?></a></h4>
											<p><?php esc_html_e('Replace the QuantumCloud Logo and branding with yours. Suitable for developers and agencies interested in providing ChatBot services for their clients.', 'woochatbot'); ?><p/>
										</div>
									</div>
								</div><!--/qc-column-4 -->
								...
								<div class="qc-column-6"><!-- qc-column-4 -->
									...
									<div class="support-block support-block-custom">
										...
										<div class="support-block-info">
											<h4><a href="<?php echo esc_url('https://www.quantumcloud.com/products/chatbot-addons/'); ?>" target="_blank"><?php esc_html_e('Mailing List Integration AddOn', 'woochatbot'); ?></a></h4>
											<p><?php esc_html_e('Mailing List Integration is the ChatBot addon that lets you connect with your Mailchimp and Zapier accounts. You can add new subscribers to your Mailchimp Lists from the ChatBot and unsubscribe them. You can also create new Zap on your Zapier Account and connect with this addon.', 'woochatbot'); ?><p/>
										</div>
									</div>
								</div><!--/qc-column-4 -->
								...
								<div class="qc-column-12"><!-- qc-column-4 -->
									...
									<div class="support-block ">
										...
										<div class="support-block-info">
											<h4><a href="<?php echo esc_url('https://www.quantumcloud.com/products/themes/woowbot-theme/'); ?>" target="_blank"><?php esc_html_e('WoowBot Master Theme', 'woochatbot'); ?></a></h4>
											<p style="margin-top: -18px;"><?php esc_html_e('Get a WoowBot Powered Theme!', 'woochatbot'); ?></p>
										</div>
									</div>
								</div><!--/qc-column-4 -->
       ...
       <style>
        ...
        <div class="notice notice-info is-dismissible woowbot-notice" style="display:none;width: 100%; max-width: 1300px;">
            <div class="woowbot_info_carousel">
                ...
                <div class="woowbot_info_item"><?php esc_html_e('**Pro Tip: Want to make WoowBot Really intelligent with', 'woochatbot'); ?> <strong style="color: yellow"><?php esc_html_e('AI and Natural Language Processing?', 'woochatbot'); ?></strong>  <?php esc_html_e('Upgrade to the Pro version', 'woochatbot'); ?> </div>

                <div class="woowbot_info_item"><?php esc_html_e('**Pro Tip: WoowBot Pro is fully integrated with', 'woochatbot'); ?> <strong style="color: yellow"><?php esc_html_e('Google\'s DialogFlow AI and Machine Learning', 'woochatbot'); ?></strong> </div>

                <div class="woowbot_info_item"><?php esc_html_e('**Pro Tip: Create', 'woochatbot'); ?>  <strong style="color: yellow"><?php esc_html_e('Custom Intents and Rich Message', 'woochatbot'); ?></strong> <?php esc_html_e('Responses from Dialogflow with WoowBot Pro version.', 'woochatbot'); ?></div>

                <div class="woowbot_info_item"><?php esc_html_e('**Pro Tip: Are your customers adding products to the cart but not completing order and losing you money? Find out with the', 'woochatbot'); ?> <strong style="color: yellow"><?php esc_html_e('Customer Conversion report', 'woochatbot'); ?></strong>  <?php esc_html_e('in the Pro version', 'woochatbot'); ?>.</div>

                <div class="woowbot_info_item"><?php esc_html_e('**Pro Tip:', 'woochatbot'); ?> <strong style="color: yellow"><?php esc_html_e('Schedule WoowBot Pro', 'woochatbot'); ?></strong> <?php esc_html_e('to run only outside of your normal business hours. Use WoowBot with another Live Chat service!', 'woochatbot'); ?></div>

                <div class="woowbot_info_item"><?php esc_html_e('**Pro Tip: Utilize Onsite Retargeting for', 'woochatbot'); ?> <strong style="color: yellow"><?php esc_html_e('Exit Intent or Scroll down Popups', 'woochatbot'); ?></strong> <?php esc_html_e('with WoowBot Pro. Increase sales by 50% or more!', 'woochatbot'); ?></div>

                <div class="woowbot_info_item"><?php esc_html_e('**Pro Tip: Setting up WoowBot pro is easy and quick! It\'s all', 'woochatbot'); ?> <strong style="color: yellow"><?php esc_html_e('Plug and Play', 'woochatbot'); ?></strong>. <?php esc_html_e('No complex bot training required!', 'woochatbot'); ?> </div>

                <div class="woowbot_info_item"><?php esc_html_e('**Pro Tip: WoowBot pro integrates with', 'woochatbot'); ?> <strong style="color: yellow"><?php esc_html_e('Skype, Whatsapp, Viber, Facebook, eMail', 'woochatbot'); ?></strong> <?php esc_html_e('and more to give your customers the support they deserve. Increase customer satisfaction!', 'woochatbot'); ?> </div>
            </div>
